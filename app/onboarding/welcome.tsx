...
const GUIDE_SLIDES: GuideSlide[] = [
  {
    id: 'what',
    title: '오늘은 어떻게 씻을까요?',
    body: '피곤하거나 잠이 안 오거나 몸이 무거운 날이 있죠. 바스타임은 그런 날, 오늘 몸에 맞는 씻는 방법을 가볍게 정해줘요.',
    points: ['샤워만으로도 가능', '온도와 시간만 확인', '바로 시작'],
  },
  {
    id: 'how',
    title: '복잡하게 하지 않아도 괜찮아요',
    body: '샤워, 족욕, 욕조 중 지금 가능한 방식만 고르면 돼요. 바스타임이 온도와 시간, 진행 순서를 짧게 안내해요.',
    points: ['가능한 방식 선택', '핵심만 확인', '타이머로 따라가기'],
  },
  {
    id: 'safety',
    title: '무리한 의식은 먼저 걸러요',
