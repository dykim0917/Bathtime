...
const styles = StyleSheet.create({
  ...
  hero: { height: HERO_HEIGHT + 8, borderBottomLeftRadius: luxuryRadii.cardLg, borderBottomRightRadius: luxuryRadii.cardLg, overflow: 'hidden' },
  ...
  navCenterTitle: { flex: 1, textAlign: 'center', fontSize: TYPE_BODY, fontWeight: '700', color: V2_TEXT_PRIMARY, paddingHorizontal: 4, fontFamily: luxuryFonts.sans },
  ...
  modeChipText: { fontSize: TYPE_CAPTION, fontWeight: '700', color: V2_TEXT_PRIMARY, fontFamily: luxuryFonts.sans },
  heroContent: { flex: 1, justifyContent: 'flex-end', alignItems: 'center', paddingHorizontal: 24, paddingBottom: 18 },
  ...
  heroModeLabel: { fontSize: TYPE_CAPTION, color: 'rgba(255,255,255,0.88)', textAlign: 'center', fontWeight: '600', letterSpacing: luxuryTracking.label, fontFamily: luxuryFonts.sans },
  scrollView: { flex: 1 },
  ...
  evidenceText: { fontSize: TYPE_CAPTION, color: V2_TEXT_PRIMARY, lineHeight: 18, fontFamily: luxuryFonts.sans },
  evidenceSafetyText: { marginTop: 1, fontSize: TYPE_CAPTION, color: V2_TEXT_SECONDARY, lineHeight: 18, fontWeight: '700', fontFamily: luxuryFonts.sans },
  statsCard: { flexDirection: 'row', alignItems: 'center', paddingVertical: 16, paddingHorizontal: 10, marginBottom: 12 },
  statItem: { flex: 1, alignItems: 'center' },
  statValue: { fontSize: TYPE_TITLE + 2, color: V2_TEXT_PRIMARY, marginBottom: 2, fontFamily: luxuryFonts.display },
  statLabel: { fontSize: TYPE_CAPTION, color: V2_TEXT_SECONDARY, fontFamily: luxuryFonts.sans },
  ...
  lightingLabel: { fontSize: TYPE_BODY, fontWeight: '600', color: V2_TEXT_SECONDARY, fontFamily: luxuryFonts.sans },
  lightingValue: { fontSize: TYPE_BODY, color: V2_TEXT_PRIMARY, flex: 1, fontFamily: luxuryFonts.sans },
  ...
  safetyTitle: { fontSize: TYPE_TITLE, color: V2_TEXT_PRIMARY, marginBottom: 6, fontFamily: luxuryFonts.display },
