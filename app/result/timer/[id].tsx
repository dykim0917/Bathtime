...
const styles = StyleSheet.create({
  ...
  routineStatusMeta: { fontSize: TYPE_CAPTION - 1, color: V2_ACCENT, fontWeight: '800', letterSpacing: 1.2, fontFamily: luxuryFonts.sans },
  ...
  soundEyebrow: { fontSize: TYPE_CAPTION - 1, color: V2_ACCENT, fontWeight: '800', letterSpacing: 1.4, fontFamily: luxuryFonts.sans },
