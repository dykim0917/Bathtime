...
export const AUDIO_ASSETS: Record<string, any> = {
  ...
  ocean: require('../../assets/audio/ambience/ocean.mp3'),
  forest: require('../../assets/audio/ambience/forest.mp3'),
  hotspring: require('../../assets/audio/ambience/hotspring.mp3'),
  fireplace: require('../../assets/audio/ambience/fireplace.mp3'),
};
