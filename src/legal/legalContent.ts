...
export const PRIVACY_LABELS = [
  ...
  { title: '이용 목적', value: '맞춤 입욕 루틴 제공, 저장/제보 관리, 안정성 확인' },
...
export const PRIVACY_POLICY_SECTIONS: LegalBulletSection[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      '서비스 이용 정보: 저장한 콘텐츠, 제보 유형, 링크 또는 이미지, 제보 코멘트, 공개 닉네임, 공개 가능 여부',
  ...
  },
  {
    ...
    bullets: [
      ...
      '소셜 로그인 계정 및 저장 콘텐츠: 회원 탈퇴 또는 삭제 요청 처리 시까지',
  ...
  },
  {
    title: '9. 개인정보 처리위탁',
    body:
      '현재 바스타임은 개인정보 처리 업무를 외부 업체에 위탁하고 있지 않습니다. 향후 위탁이 발생하면 수탁자, 위탁 업무, 보유·이용 기간을 처리방침에 반영합니다.',
  },
  {
    title: '10. 자동 수집 장치의 설치·운영 및 거부',
    bullets: [
      '바스타임은 서비스 접속 상태 유지와 기본 동작을 위해 쿠키 또는 이에 준하는 저장수단을 사용할 수 있습니다.',
      '소셜 로그인 세션 유지와 로그인 후 원래 작업을 이어가기 위해 브라우저 저장수단을 사용할 수 있습니다.',
...
export const TERMS_OF_SERVICE_SECTIONS: LegalBulletSection[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      '소셜 로그인을 통한 콘텐츠 저장, 보관함 조회, 제보 제출 및 제보 상태 관리',
      '운영자가 추가로 정하는 부가 기능',
    ],
  },
  {
