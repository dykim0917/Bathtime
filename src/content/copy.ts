export const copy = {
  ...
  routine: {
    ...
    recipe: {
      ...
      guideTitle: '준비물 가이드',
      guideSubtitle: '없음 또는 완제품 한 개만 준비하면 되도록 정리했어요',
      requiredLabel: '필수 준비물',
      optionalLabel: '있으면 좋아요',
      noneTitle: '없음',
      ...
      noRequiredBody: '새로 준비물을 사지 않아도 지금 바로 시작할 수 있어요.',
