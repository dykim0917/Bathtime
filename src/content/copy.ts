...
export const copy = {
  ...
  routine: {
    ...
    recipe: {
      ...
      prepTitle: '필요한 것만 확인해요',
      prepSubtitle: '길게 읽지 않아도 바로 시작할 수 있게 핵심만 정리했어요.',
      guideTitle: '있으면 좋은 것',
      guideSubtitle: '새로 준비하지 않아도 괜찮아요. 가능한 것만 확인해요.',
  ...
  careCards: {
    ...
    disabledFooter: '가능한 방식 먼저 보기',
    defaultFooter: '간단히 시작',
    secondaryFooter: '다르게 고르기',
