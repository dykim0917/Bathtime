...
| SafetyWarning 연결 | 경고 모달 렌더링 | Line 409-413: visible/warnings/onDismiss 연결 | PASS |
...
| SafetyWarning 연결 | 경고 모달 연결 | Line 349-353 | PASS |
...
| SafetyWarning | Care + Trip 재사용 | care.tsx Line 409, trip.tsx Line 349 | PASS |
