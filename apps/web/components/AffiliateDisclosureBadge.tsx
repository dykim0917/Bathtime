...
const disclosureText = [
  '이 글에는 쿠팡 파트너스, 오늘의집 큐레이터, 올리브영 쇼핑 큐레이터, 숙박 예약 제휴 링크가 포함될 수 있습니다.',
  '링크를 통해 구매 또는 예약이 발생하면 바스타임에 수수료가 지급될 수 있습니다.',
  '제품과 숙소 선택 기준은 바스타임의 리서치 기준으로 정리하며, 직접 사용 또는 숙박 후기처럼 작성하지 않습니다.',
];
