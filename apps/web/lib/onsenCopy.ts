export function normalizeOnsenPublicCopy(text: string) {
  return text
    ...
    .replaceAll('대여 가족탕', '가족탕/대절탕')
    .replaceAll('공식 설명과 후기를 함께 검토', '공식 설명과 이용 조건을 함께 검토')
    .replaceAll('직수 온천 언급', '직수 온천 확인 필요')
    ...
    .replaceAll('넓은 가족탕/대절탕이 확인되지만 선착순 대기 후기가 반복됩니다.', '넓은 가족탕/대절탕이 확인되며, 선착순 이용이라 대기가 생길 수 있습니다.')
