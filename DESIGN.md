# Design System — Bath Sommelier

## Product Context
- **What this is:** 입욕 환경과 컨디션에 맞춰 홈 배스 루틴을 추천하고, 타이머와 회고까지 이어주는 모바일 웰니스 앱.
- **Who it's for:** 웰니스에 시간과 돈을 쓰려는 20-40대 일반 소비자 중, 입문자에 가까운 실용형 사용자.
- **Space/industry:** 홈 스파, 부티크 호텔 배스 어메니티, 니치 향 브랜드와 맞닿아 있는 프리미엄 웰니스.
- **Project type:** 모바일 앱 중심의 추천형 웰니스 제품.

## Aesthetic Direction
- **Direction:** Quiet Luxury Spa
- **Decoration level:** Intentional
- **Mood:** 명상 앱처럼 추상적이지 않고, 믿을 수 있는 배스 코치처럼 차분하고 정제되어야 한다. 향과 물성의 여백은 느껴지되, 사용자는 언제나 다음 행동을 분명히 알아야 한다.
- **Reference cues:** 홈 스파, 부티크 호텔 배스룸, 프리미엄 어메니티, 에디토리얼 웰니스 북.
...
## Layout
- **Approach:** Hybrid
- **App shell:** 정돈된 단일 컬럼과 안정적인 카드 스택.
- **Editorial moments:** 홈 히어로, 트립 카드, 루틴 완료 화면에서만 에디토리얼 톤을 허용한다.
...
## Voice In UI
- **Tone:** 안전한 코치, 조용한 프리미엄, 과장 없는 안내.
- **Do:** "지금 환경에 맞는 루틴", "바로 시작할 수 있어요", "안전하게 진행해요"
- **Don't:** 몽환적 추상 카피, 과도한 힐링 문구, 럭셔리 과시.
